...
<body>
	...
	<div class=\"content\">
		<div class=\"container\">
			...
			$sql = "select embg_u,img_path,imeU,PrezimeU from ucenici";
	...
	while ($row=$result->fetch_object()){
		...
		echo "<li><img src=\"$img_path\" alt=\"$img\" width=\"200\"></a></li>";
		echo "<a href=\"student_single.php?id=$embg\">".$ime." ".$prezime."</a>";
 	}
