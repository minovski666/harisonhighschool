...
<body>
	...
	<div class=\"content\">
		<div class=\"container\">
			...
			$sql = "select embg_p,img_path,imeP,prezimeP from profesori";
	...
	while ($row=$result->fetch_object()){
		...
		echo "<li><a href=\"profesor_single.php?id=$embg\"><img src=\"$img_path\" alt=\"$img\" width=\"200\"></a></li>";
		echo "<a href=\"profesor_single.php?id=$embg\">".$ime." ".$prezime."</a>";
 	}
