...
<ul class=\"topnav\" id=\"myTopnav\">
	<li><a href=\"".$settings['website_url']."administration/sekcii/insert.php\">NEW</a></li> 
</ul>
...
<tr><td>Oblast</td><td>Nedelno</td><td>edit</td><td>delete</td><td>multidelete</td></tr>";	
  
  $sql = "select * from sekcii";
	...
	while ($row=$result->fetch_object()){
		...
		if($oblast==$_GET['id'])$bgcolor="blue";
		
		
		echo	"<tr bgcolor=$bgcolor>
				<td>$oblast</td><td>$nedelno</td>
				<td><a href=\"".$settings['website_url']."administration/sekcii/edit.php?id=$oblast\"><img src=\"".$settings['website_url']."images/edit.png\" width=20 alt=\"edit\"></a></td>
				<td><a onclick=\"return delete_ad('".$oblast."')\" ><img src=\"".$settings['website_url']."images/delete.png\" width=20 alt=\"delete\"></a></td>
				<td><input type=\"checkbox\" name=\"check[]\" value=\"$oblast\" /></td>	
		</tr>";
		}
