...
<form name=\"myForm\" action=\"insert_exe.php\" method=\"post\" onsubmit=\"return sekci()\">
<table border=\"1\" style=\"border: black\" align=\"center\"  width=\"100%\">
		
		<tr><td>oblast</td><td><input type=\"text\" name=\"oblast\" value=\"\" /></td></tr>
		<tr><td>nedelno</td><td><input type=\"text\" name=\"nedelno\" value=\"\" /></td></tr>
...
<script src=\"".$settings['website_url']."administration/js/validationSekci.js\"></script>
</html>
";
?>