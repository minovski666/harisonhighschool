...
<form name=\"myForm\" action=\"edit_exe.php\" method=\"post\" onsubmit=\"return arhiva()\">
<table border=\"1\" style=\"border: black\" align=\"center\"  width=\"100%\">
<tr><td>Sifra</td><td>Kolicina</td><td>Predmet</td></tr>";	
  
  $sql = "select * from arhiva WHERE arhiva_id=".$_GET['id'];
	...
	while ($row=$result->fetch_object()){
		...
		echo	"<tr>
				<td><input type=\"hidden\" name=\"arhiva_id\" value=\"$arhiva\" />$sifra</td><td><input type=\"text\" name=\"kolicina\" value=\"$kolicina\" /></td><td>$predmet</td>
		</tr>";
		}
