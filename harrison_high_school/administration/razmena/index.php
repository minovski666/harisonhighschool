...
<ul class=\"topnav\" id=\"myTopnav\">
	<li><a href=\"".$settings['website_url']."administration/razmena/insert.php\">NEW</a></li>
...
<tr><td>Slika</td><td>Grad</td><td>Drzava</td><td>Uciliste</td><td>edit</td><td>delete</td><td>multidelete</td></tr>";	
  
  $sql = "select * from razmena";
	$result=	$connection->query($sql);	
	while ($row=$result->fetch_object()){
		$grad=$row->grad;
		$drzava=$row->drzava;
		$uciliste=$row->uciliste;
		$bgcolor="yellow";
		
		if($grad==$_GET['id'])$bgcolor="blue";
	...
	$img_path=$settings['website_url']."upload/".$img;
		...
		echo	"<tr bgcolor=$bgcolor>
				<td><img src=\"$img_path\" width=\"50\" alt=\"$img\" /></td><td>$grad</td><td>$drzava</td><td>$uciliste</td>
				<td><a href=\"".$settings['website_url']."administration/razmena/edit.php?id=$grad\"><img src=\"".$settings['website_url']."images/edit.png\" width=20 alt=\"edit\"></a></td>
					<td><a onclick=\"return delete_ad('".$grad."')\" ><img src=\"".$settings['website_url']."images/delete.png\" width=20 alt=\"delete\"></a></td>
					<td><input type=\"checkbox\" name=\"check[]\" value=\"$grad\" /></td>
		</tr>";
		}
