...
<form name=\"myForm\" enctype=\"multipart/form-data\" action=\"insert_exe.php\" method=\"post\" onsubmit=\"return razmena()\">
<table border=\"1\" style=\"border: black\" align=\"center\"  width=\"100%\">
		
		<tr><td>grad</td><td><input type=\"text\" name=\"grad\" value=\"\" /></td></tr>
		<tr><td>drzava</td><td><input type=\"text\" name=\"drzava\" value=\"\" /></td></tr>
		<tr><td>uciliste</td><td><input type=\"text\" name=\"uciliste\" value=\"\" /></td></tr>
...
<script src=\"".$settings['website_url']."administration/js/validationRazmena.js\"></script>
</html>
";
?>