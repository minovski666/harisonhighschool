...
<div id=\"Content\">
<form name=\"myForm\" action=\"edit_exe.php\" method=\"post\" onsubmit=\"return razmena()\">
<table border=\"1\" style=\"border: black\" align=\"center\"  width=\"100%\">
<tr><td>Grad</td><td>Drzava</td><td>Uciliste</td></tr>";	
  
  $sql = "select * from razmena where grad like \"".$_GET['id']."\"";
	...
	while ($row=$result->fetch_object()){
		...
		echo	"<tr>
				<td><input type=\"hidden\" name=\"grad\" value=\"$grad\" />$grad</td>
				<td>$drzava</td>
				<td><input type=\"text\" name=\"uciliste\" value=\"$uciliste\" /></td>
		</tr>";
		}
