...
<ul class=\"topnav\" id=\"myTopnav\">
	<li><a href=\"".$settings['website_url']."administration/biblioteka/insert.php\">NEW</a></li>
...
<tr><td>Sifra</td><td>Tip</td><td>edit</td><td>delete</td><td>multidelete</td></tr>";	
  ...
  $sql = "select * from biblioteka";
	...
	while ($row=$result->fetch_object()){
		...
		if($sifra==$_GET['id'])$bgcolor="blue";
		
		echo	"<tr bgcolor=$bgcolor>
				<td>$sifra</td><td>$tip</td>
				<td><a href=\"".$settings['website_url']."administration/biblioteka/edit.php?id=$sifra\"><img src=\"".$settings['website_url']."images/edit.png\" width=20 alt=\"edit\"></a></td>
					<td><a onclick=\"return delete_ad('".$sifra."')\" ><img src=\"".$settings['website_url']."images/delete.png\" width=20 alt=\"delete\"></a></td>
					<td><input type=\"checkbox\" name=\"check[]\" value=\"$sifra\" /></td>
		</tr>";
		}
