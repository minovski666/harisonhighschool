...
<div id=\"Content\">
<form name=\"myForm\" action=\"edit_exe.php\" method=\"post\" onsubmit=\"return biblioteka()\">
<table border=\"1\" style=\"border: black\" align=\"center\"  width=\"100%\">
<tr><td>Sifra</td><td>Tip</td></tr>";
	
  
  
  $sql = "select * from biblioteka where sifra like \"".$_GET['id']."\"";
	...
	while ($row=$result->fetch_object()){
		...
		echo	"<tr>
				<td><input type=\"hidden\" name=\"sifra\" value=\"$sifra\" /></td>
...
<script src=\"".$settings['website_url']."administration/js/validationBiblioteka.js\"></script>
</html>
";
?>