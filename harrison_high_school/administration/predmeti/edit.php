...
<div id=\"Content\">
<form name=\"myForm\" action=\"edit_exe.php\" method=\"post\" onsubmit=\"return predmeti()\">
<table border=\"1\" style=\"border: black\" align=\"center\"  width=\"100%\">
<tr><td>Predmet</td><td>Zadolzitelen</td><td>Izboren</td></tr>";	
  
  $sql = "select * from predmeti where predmet_id like \"".$_GET['id']."\"";
	...
	while ($row=$result->fetch_object()){
		...
		echo	"<tr>
					<td><input type=\"hidden\" name=\"predmet_id\" value=\"$predmet\" />$predmet</td>
					<td><input type=\"text\" name=\"zadolzitelen\" value=\"$zadolzitelen\" /></td>
					<td><input type=\"text\" name=\"izboren\" value=\"$izboren\" /></td>
				</tr>";
		}
