...
<form name=\"myForm\" action=\"insert_exe.php\" method=\"post\" onsubmit=\"return predmet()\">
<table border=\"1\" style=\"border: black\" align=\"center\"  width=\"100%\">
		
		<tr><td>predmet_id</td><td><input type=\"text\" name=\"predmet_id\" value=\"\" /></td></tr>
		
		<tr><td>zadolzitelen</td><td>
		<select name=\"zadolzitelen\">
...
<script src=\"".$settings['website_url']."administration/js/validationPredmeti.js\"></script>
</html>
";
?>