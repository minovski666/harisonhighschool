...
<ul class=\"topnav\" id=\"myTopnav\">
	<li><a href =\"".$settings['website_url']."administration/natprevari/insert.php\">NEW</a></li> 
</ul>
...
<tr><td>Odrzan na</td><td>Nagradi</td><td>edit</td><td>delete</td><td>multidelete</td></tr>";
	
  
  
  $sql = "select * from natprevari";
	$result=	$connection->query($sql);	
	while ($row=$result->fetch_object()){
		$odrzan=$row->odrzan_na;
		$nagradi=$row->nagradi;
		$natprevari=$row->natprevar_id;
		$bgcolor="yellow";
		if($natprevari==$_GET['id'])$bgcolor="blue";
		
		echo	"<tr bgcolor=$bgcolor>
				<td>$odrzan</td><td>$nagradi</td>
				<td><a href=\"".$settings['website_url']."administration/natprevari/edit.php?id=$natprevari\"><img src=\"".$settings['website_url']."images/edit.png\" width=20 alt=\"edit\"></a></td>
					<td><a onclick=\"return delete_ad('".$natprevari."')\" ><img src=\"".$settings['website_url']."images/delete.png\" width=20 alt=\"delete\"></a></td>
					<td><input type=\"checkbox\" name=\"check[]\" value=\"$natprevari\" /></td>
		</tr>";
		}
